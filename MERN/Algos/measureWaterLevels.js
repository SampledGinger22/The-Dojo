 ...
 */
 ...
 function measureWaterLevels(waterLevels) {
    ...
    while(highIdx < waterLevels.length){
        if(waterLevels[highIdx] > waterLevels[lowIdx] && waterLevels[highIdx] - waterLevels[lowIdx] > current){
            current = waterLevels[highIdx] - waterLevels[lowIdx];
            highIdx++;
        }
        else if(waterLevels[highIdx] < waterLevels[highIdx-1]){
            lowIdx = highIdx;
            highIdx++;
        }
        else highIdx++;
